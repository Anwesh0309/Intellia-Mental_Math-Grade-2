  ...
  return (
    <div className={`mascot-container mascot-${mood}`} aria-label={`Coach LearnFlow in ${mood} state wearing a ${beltLabel}`}>
      <svg viewBox="0 0 100 120" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="35" cy="2" r="4.5" fill="#FFB300" className={mood === 'celebrating' ? 'mascot-antenna-glow' : ''} />
        
        <path d="M 60 20 L 65 5 Q 67 2 65 1" stroke="url(#metalGrad)" strokeWidth="3.5" fill="none" strokeLinecap="round" />
        <circle cx="65" cy="2" r="4.5" fill="#FFB300" className={mood === 'celebrating' ? 'mascot-antenna-glow' : ''} />
        ...
        {/* Head Shell */}
        <rect x="10" y="15" width="80" height="42" rx="20" fill="url(#bodyGrad)" stroke="#1565C0" strokeWidth="2.5" />

        {/* Digital Screen Face */}
        <rect x="18" y="21" width="64" height="30" rx="12" fill="url(#screenGrad)" stroke="#1E88E5" strokeWidth="2" />
        ...
        {/* Body Chest */}
        <path d="M 22 66 L 78 66 L 70 106 L 30 106 Z" fill="url(#bodyGrad)" stroke="#1565C0" strokeWidth="2.5" />

        {/* Core Heart Light */}
        <circle cx="50" cy="83" r="8" fill="#1A237E" stroke="#1E88E5" strokeWidth="1.5" />
